...
$stmt = $pdo->prepare("SELECT * FROM contrato_anexos WHERE id = ?");
$stmt->execute([$id]);
$anexo = $stmt->fetch();
...
// basename() garante que nunca haverá path traversal
...
// PDFs e imagens abrem inline; DOC/DOCX sempre forçam download
